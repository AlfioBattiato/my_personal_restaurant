  ...
  return (
    <footer>
      <div className="footerDomicilio">
        ...
        <p>
          Ordina il pranzo o la cena a base di sushi da uno dei ristoranti del
          gruppo. Scegli se fartelo consegnare a casa o se passare in ristorante
          per il ritiro.
        </p>
      ...
      <div className="contatti" id="contatti">
        ...
        <p>
          Telefono : +39 3773713765 <a href="tel:+393773713765"> Chiamaci</a>
        </p>
        <address>
          Email :<a href="mailto:battiato3@gmail.com"> battiato3@gmail.com</a>
        </address>
        <p>
          Dove ci trovi{" "}
          <a href="/">
